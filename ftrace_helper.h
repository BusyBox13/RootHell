 ...
 * setting it to 1. (Ordinarily ftrace provides it's own protections against
 ...
 * */
static int
fh_resolve_hook_address(struct ftrace_hook *hook)
{
...
static void notrace
fh_ftrace_thunk(unsigned long ip, unsigned long parent_ip,
